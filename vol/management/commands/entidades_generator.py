...
class Command(BaseCommand):
    help = "Gera uma combinação aleatória de 5 usuarios cadastrados como voluntários vinculados a 5 entidades aleatórias e, também, os insere no banco de dados."
    ...
    def handle(self, *args, **options):
        ...
        estados_cidades = {'SP': {'São Paulo', 'Santos', 'Araraquara'}, 'PR': {'Curitiba', 'Londrina', 'Pinhais'}, 'RJ': {'Rio de Janeiro', 'Niterói', 'Duque de Caxias'}, 'MG': {'Belo Horizonte', 'Contagem', 'Juiz de Fora'}, 'ES': {'Vitória', 'Serra', 'Guarapari'}, 'RS': {'Porto Alegre', 'Canoas', 'São Leopoldo'}, 'SC': {'Florianópolis', 'Joinville', 'Blumenau'}, 'MS': {'Campo Grande', 'Cuiabá', 'Dourados'}, 'MT': {'Cuiabá', 'Sorriso', 'Várzea Grande'}, 'GO': {'Goiânia', 'Anápolis', 'Trindade'}, 'TO': {'Araguaína', 'Gurupi', 'Palmas'}, 'BA': {'Salvador', 'Ilhéus', 'Camaçari'}, 'SE': {'Lagarto', 'Arapiraca', 'Aracaju'}, 'PE': {'Caruaru', 'Recife', 'Petrolina'}, 'AL': {'Arapiraca', 'Maceió', 'Penedo'}, 'PB': {'Campina Grande', 'Patos', 'Tavares'}, 'RN': {'Natal', 'Mossoró', 'Parnamirim'}, 'CE': {'Fortaleza', 'Sobral', 'Brejo Santo'}, 'PI': {'Teresina', 'Parnaíba', 'Floriano'}, 'MA': {'São Luís', 'Açailandia', 'Imperatriz'}, 'PA': {'Belém', 'Santarém', 'Marabá'}, 'AM': {'Manaus', 'Parintins', 'Manacapuru'}, 'RR': {'Boa Vista', 'Alto Alegre', 'Rorainópolis'}, 'AC': {'Rio Branco', 'Cruzeiro do Sul', 'Sena Madureira'}, 'AP': {'Macapá', 'Santana', 'Porto Grande'}, 'RO': {'Porto Velho', 'Ariquemes', 'Vilhena'}}
