...
class Voluntario(models.Model):
    ...
    entidade_que_ajudou   = models.CharField(u'Entidade que ajudou', max_length=100)
    area_trabalho         = models.ForeignKey(AreaTrabalho, verbose_name=u'Área de Trabalho', on_delete=models.PROTECT, null=True)
    ...
    fonte                 = models.CharField(u'Fonte', max_length=100)
